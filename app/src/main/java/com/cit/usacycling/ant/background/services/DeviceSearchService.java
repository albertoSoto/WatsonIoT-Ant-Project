...
public class DeviceSearchService extends Service {
    public static final String SERVICE_TAG = DeviceSearchService.class.getSimpleName();
    ...
    private final Runnable searchBsxDevices = new Runnable() {
        ...
        public void run() {
            ...
            bsxSearchHandler.postDelayed(searchBsxDevices, 10000);
        }
    };

    @Override
    public int onStartCommand(Intent intent, int flags, int startId) {
        Log.d("DeviceSearchService", "Start Command Called");
    ...
    public void onDestroy() {
        Log.d("DeviceSearchService", "OnDestroy called");
