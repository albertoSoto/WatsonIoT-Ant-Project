 ...
 */
public class HeartRateMonitorService extends AntServiceBase {
    public static final String SERVICE_TAG = HeartRateMonitorService.class.getSimpleName();
    ...
    private HeartRateMonitorService getServiceContext() {
        return this;
    }
